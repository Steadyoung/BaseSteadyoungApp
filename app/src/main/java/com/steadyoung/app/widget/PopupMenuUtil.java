package com.steadyoung.app.widget;
...
public class PopupMenuUtil {
    ...
    private LinearLayout test1Ll, test2Ll, test3Ll;
    ...
    private void initLayout(Context context) {
        ...
        test1Ll = (LinearLayout) rootVew.findViewById(R.id.test1_ll);
        test2Ll = (LinearLayout) rootVew.findViewById(R.id.test2_ll);
        test3Ll = (LinearLayout) rootVew.findViewById(R.id.test3_ll);

        rlClick.setOnClickListener(new MViewClick(context));
        test1Ll.setOnClickListener(new MViewClick(context));
        test2Ll.setOnClickListener(new MViewClick(context));
        test3Ll.setOnClickListener(new MViewClick(context));
    ...
    private class MViewClick implements View.OnClickListener {
        ...
        public MViewClick(Context context) {
            this.context = context;
        }

        @Override
        public void onClick(View v) {
            if(v.getId() == R.id.pop_rl_click){
                //加号按钮点击之后的执行
                _rlClickAction();
                return;
            }
            if(onMenuClickListener != null){
                switch (v.getId()){
                    case R.id.test1_ll:
                        onMenuClickListener.onTest1();
                        break;
                    case R.id.test2_ll:
                        onMenuClickListener.onTest2();
                        break;
                    case R.id.test3_ll:
                        onMenuClickListener.onTest3();
                        break;
                    default:
                        break;
                }
    ...
    private void _openPopupWindowAction() {
        ...
        _startAnimation(test1Ll, 600, animatorProperty);
        _startAnimation(test2Ll, 400, animatorProperty);
        _startAnimation(test3Ll, 500, animatorProperty);
    }
    ...
    public void _rlClickAction() {
        if (ivBtn != null && rlClick != null) {
            ...
            _closeAnimation(test1Ll, 300, top);
            _closeAnimation(test2Ll, 200, top);
            _closeAnimation(test3Ll, 250, top);
